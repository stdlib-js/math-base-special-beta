...
var beta = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( beta instanceof Error )
};
...
tape( 'the function evaluates the beta function (tested against R)', opts, function test( t ) {
	var actual;
	var y1;
	var y2;
	var i;
